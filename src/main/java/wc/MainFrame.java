...
public class MainFrame extends javax.swing.JFrame {
                    ...
                    if (status != null && !status.equals("Completed!")) {
                        ...
                        if (status != null && status.equals("Completed!")) {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                lst.add(url);
                                dat = obj.getString("_div_entry_content_p");
                                ldt.add(new Data(url, dat));
                            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try (PrintWriter writer = new PrintWriter("WebsiteCrawler_scraping_demo.csv")) {
            ...
            for (Data p : ldt) {
                writer.println(p.gCSV());
            }
            this.jLabel2.setText("CSV Generated successfully!");
